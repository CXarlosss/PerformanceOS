...
export const AthleteAnalyticsPage: React.FC<Props> = ({
  athleteId,
  onBack,
}) => {
  ...
  if (isLoading)
    return (
      <div style={{ padding: "80px", textAlign: "center" }}>
        ...
        >
          SISTEMA DE DIAGNÓSTICO ANALIZANDO HISTÓRICO...
        </p>
      </div>
    );
            ...
            {["4w", "8w", "12w", "all"].map((r: string) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    range === r ? "0 4px 6px -1px rgba(0,0,0,0.1)" : "none",
                  cursor: "pointer",
