...
export const AuthScreen: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Error de conexión con el backend",
      );
    } finally {
      setLoading(false);
    }
    ...
    >
      ...
      >
        <header style={{ textAlign: "center", marginBottom: "32px" }}>
          <h1 style={{ color: "var(--primary)", letterSpacing: "-0.04em" }}>
            PerformanceOS
          </h1>
          <p style={{ color: "var(--text-muted)", fontSize: "14px" }}>
            Entra en tu entorno de alto rendimiento
          </p>
        </header>
        ...
        >
          ...
          <p
            style={{ fontSize: "12px", textAlign: "center", color: "#94a3b8" }}
          >
