...
let WorkoutsController = class WorkoutsController {
    ...
    async postSet(dto) {
        return this.workoutsService.createWorkoutSet(dto);
    }
    async getMyWorkouts(req) {
        return this.workoutsService.getSessionsForAthlete(req.user.athleteId || req.user.userId);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_workout_set_dto_1.CreateWorkoutSetDto]),
    __metadata("design:returntype", Promise)
], WorkoutsController.prototype, "postSet", null);
__decorate([
    (0, common_1.Get)('me'),
